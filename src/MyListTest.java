...
public class MyListTest {
	...
	//Asegura que un NullPointerException es enviado cuando se envia un objeto nulo
	...
	//Asegura que no puede encontrar ningun tipo de objeto que no se encuentre dentro de la lista
	@Test
	...
	//Prueba que la función get este devolviendo el valor correcto para un elemento ya conocido de la lista.
	@Test
	public void testGet(){
		assertEquals(myList1.get(0), "a");
	}
	
	//Prueba que el método get retorne una excepcion en caso que la lista este vacia
	@Test (expected=IndexOutOfBoundsException.class)
	public void testGetEmpty(){
		myList2.get(0);
	}
	
	//Prueba que el método get no retorna el último elemento de la lista cuando se solicita 
	//un valor más alto que el tamaño de la misma sino en su lugar devuelve una excepcion.
	@Test (expected=IndexOutOfBoundsException.class)
	...
	//Asumimos que para que dos listas sean intercalables deben tener el mismo tamaño
	@Test
	...
	//Prueba de intentar realizar un intercalamiento con la lista 2 la cual debe ser imposible debido
